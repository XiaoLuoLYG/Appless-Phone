...
Animated previews autoplay on GitHub. Click any preview to open the compressed MP4. The Chinese text is the exact query used in the demo, followed by a short English translation.

### Travel and local life

<table>
  <tr>
    <td align="center" width="33%"><a href="docs/assets/demos/latest/travel-beijing-shanghai.mp4"><img src="docs/assets/demos/gifs/travel-beijing-shanghai.gif" alt="Travel demo" /></a><br><sub><code>我明天要从北京去上海，帮我搜索合适的出行方式</code><br>Find suitable travel options from Beijing to Shanghai tomorrow</sub></td>
    <td align="center" width="33%"><a href="docs/assets/demos/latest/food-coffee-huawei.mp4"><img src="docs/assets/demos/gifs/food-coffee-huawei.gif" alt="Coffee search demo" /></a><br><sub><code>帮我查深圳坂田华为基地附近的咖啡店</code><br>Find coffee near Huawei Base in Bantian, Shenzhen</sub></td>
    <td align="center" width="33%"><a href="docs/assets/demos/latest/google-maps-kings-cross.mp4"><img src="docs/assets/demos/gifs/google-maps-kings-cross.gif" alt="Google Maps demo" /></a><br><sub><code>帮我用 Google Maps 搜索伦敦国王十字车站附近的中餐</code><br>Search Google Maps for Chinese food near King's Cross</sub></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/mail-important-aggregate.mp4"><img src="docs/assets/demos/gifs/mail-important-aggregate.gif" alt="Mail aggregation demo" /></a><br><sub><code>帮我查看邮箱里最新的重要邮件</code><br>Show the latest important emails across my inboxes</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/gmail-eccv-paper.mp4"><img src="docs/assets/demos/gifs/gmail-eccv-paper.gif" alt="Gmail ECCV demo" /></a><br><sub><code>帮我查看我Gmail里和我eccv论文相关的邮件</code><br>Find Gmail messages related to my ECCV paper</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/gmail-web.mp4"><img src="docs/assets/demos/gifs/gmail-web.gif" alt="Gmail web demo" /></a><br><sub><code>帮我打开 Gmail 网页版</code><br>Open Gmail on the web</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/calendar-month.mp4"><img src="docs/assets/demos/gifs/calendar-month.gif" alt="Calendar month demo" /></a><br><sub><code>帮我查看我本月的calendar日程</code><br>Show this month's Google Calendar events</sub></td>
  </tr>
  <tr>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/calendar-create-aiphonedemo.mp4"><img src="docs/assets/demos/gifs/calendar-create-aiphonedemo.gif" alt="Calendar create demo" /></a><br><sub><code>帮我在 2026年7月30日下午3点创建一个title为AIPhoneDemo的30分钟日程</code><br>Create a 30-minute AIPhoneDemo event on July 30, 2026 at 3 PM</sub></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/media-qwen-official.mp4"><img src="docs/assets/demos/gifs/media-qwen-official.gif" alt="Qwen media search demo" /></a><br><sub><code>帮我在b站和youtube里搜索qwen的官方视频</code><br>Search Bilibili and YouTube for official Qwen videos</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/youtube-world-cup.mp4"><img src="docs/assets/demos/gifs/youtube-world-cup.gif" alt="YouTube World Cup demo" /></a><br><sub><code>帮我在 YouTube 里搜索世界杯相关视频</code><br>Search YouTube for World Cup videos</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/memory-luckin.mp4"><img src="docs/assets/demos/gifs/memory-luckin.gif" alt="Memory update demo" /></a><br><sub><code>我只喝瑞幸咖啡</code><br>Remember that I only drink Luckin Coffee</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/payment-paypal-send.mp4"><img src="docs/assets/demos/gifs/payment-paypal-send.gif" alt="PayPal payment demo" /></a><br><sub><code>用 PayPal 给罗一格转 1 美元</code><br>Send Luo Yige 1 USD with PayPal</sub></td>
  </tr>
  <tr>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/stripe-receiving-account.mp4"><img src="docs/assets/demos/gifs/stripe-receiving-account.gif" alt="Stripe receiving account demo" /></a><br><sub><code>帮我创建我的stripe收款账户</code><br>Create my Stripe receiving account</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/payment-google-pay-send.mp4"><img src="docs/assets/demos/gifs/payment-google-pay-send.gif" alt="Google Pay payment demo" /></a><br><sub><code>用 Google Pay 给罗一格转账 5 美元</code><br>Send Luo Yige 5 USD with Google Pay</sub></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/composio-github-prs.mp4"><img src="docs/assets/demos/gifs/composio-github-prs.gif" alt="Composio GitHub demo" /></a><br><sub><code>帮我在 GitHub 里找 Appless-Phone 最近的 pr</code><br>Find recent Appless-Phone pull requests in GitHub</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/composio-google-docs.mp4"><img src="docs/assets/demos/gifs/composio-google-docs.gif" alt="Composio Google Docs demo" /></a><br><sub><code>帮我在 Google Docs 里找 AIPhoneDemo 设计文档</code><br>Find the AIPhoneDemo design doc in Google Docs</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/composio-google-drive.mp4"><img src="docs/assets/demos/gifs/composio-google-drive.gif" alt="Composio Google Drive demo" /></a><br><sub><code>帮我在 Google Drive 里找专利申请交底书</code><br>Find a patent disclosure file in Google Drive</sub></td>
    <td align="center" width="25%"><a href="docs/assets/demos/latest/composio-connections.mp4"><img src="docs/assets/demos/gifs/composio-connections.gif" alt="Composio connection management demo" /></a><br><sub><code>打开 Composio 授权配置</code><br>Review Composio app connections and OAuth status</sub></td>
  </tr>
</table>
