...
test('accepts a page action on a new turn and rejects reuse of the query turn', () => {
  const logs = `
    [AIPhone][MultiAgentPageActionDispatch] conversation=c1 origin=t2 turn=t6 surface=loop_surface_1784768562643 source=mail.search action=mail.thread.read dispatch=r9
  ...
  assert.equal(mailThreadReadEvidence(
    logs.replaceAll('turn=t6 task=k7', 'turn=t4 task=k5')
      .replaceAll('run=r9', 'run=r5'),
    options
  ).complete, false);
  assert.equal(mailThreadReadEvidence(
...
test('rejects an unrelated direct ActionRun chain in the same capture window', () => {
  const logs = `
    [AIPhone][MultiAgentPageActionDispatch] conversation=c1 origin=t2 turn=t6 surface=s1 source=mail.search action=mail.thread.read dispatch=r9
    ...
    [AIPhone][MultiAgentActionRun] conversation=c1 turn=t7 task=k8 surface=s1 plan=p9 run=r10 action=hotel.navigate source=hotel.search
...
test('collapses physical MailDetailInPlace copies but rejects two semantic terminals', () => {
  const logs = `
07-23 09:03:11.242 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentPageActionDispatch] conversation=c1 origin=t2 turn=t6 surface=loop_surface_1784768562643 source=mail.search action=mail.thread.read dispatch=r9
07-23 09:03:11.242 30850 30850 I A03D00/com.example.aiphonedemo/JSAPP: [AIPhone][MultiAgentPageActionDispatch] conversation=c1 origin=t2 turn=t6 surface=loop_surface_1784768562643 source=mail.search action=mail.thread.read dispatch=r9
07-23 09:03:11.243 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentActionRun] conversation=c1 turn=t6 task=k7 surface=loop_surface_1784768562643 plan=p8 run=r9 action=mail.thread.read source=mail.search provider=qq identity=d08b260c
07-23 09:03:11.244 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentUiTask] conversation=c1 turn=t10 task=k11 dataTasks=k12
07-23 09:03:11.245 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentDataTask] conversation=c1 turn=t10 task=k12 round=invalid tool=mail.thread.read predecessor=none path=none target=none binding=false provider=qq identity=d08b260c
07-23 09:03:11.246 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentActionResult] conversation=c1 turn=t6 task=k7 surface=loop_surface_1784768562643 plan=p8 run=r9 status=success
07-23 09:03:11.247 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentUiResult] conversation=c1 turn=t10 task=k11 surface=loop_surface_1784768591244 state=skeleton
07-23 09:03:12.330 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentDataResult] conversation=c1 turn=t10 task=k12 tool=mail.thread.read status=success sources=1 error=false provider=qq identity=d08b260c
07-23 09:03:12.331 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MailDetailInPlace] requestKeyChars=7 provider=qq identity=d08b260c status=success bodyChars=412
07-23 09:03:12.331 30850 30850 I A03D00/com.example.aiphonedemo/JSAPP: [AIPhone][MailDetailInPlace] requestKeyChars=7 provider=qq identity=d08b260c status=success bodyChars=412
07-23 09:03:12.332 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentUiResult] conversation=c1 turn=t10 task=k11 surface=loop_surface_1784768591244 state=result
  `;
  const options = {
    expectedActionId: 'mail.thread.read',
    expectedSourceToolId: 'mail.search',
  ...
  assert.equal(mailThreadReadEvidence(logs, options).ok, true);
  const secondSemanticTerminal =
    '07-23 09:03:12.332 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: ' +
    '[AIPhone][MailDetailInPlace] requestKeyChars=7 provider=qq identity=d08b260c status=success bodyChars=412\n';
  assert.equal(mailThreadReadEvidence(
    logs.replace(
      '07-23 09:03:12.332 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentUiResult]',
      secondSemanticTerminal +
        '07-23 09:03:12.333 30850 30850 I A00000/com.example.aiphonedemo/AIPhone: [AIPhone][MultiAgentUiResult]'
    ),
    options
  ).complete, false);
});
